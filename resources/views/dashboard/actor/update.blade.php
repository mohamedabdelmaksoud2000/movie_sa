...
@section('content')
				<!-- Row -->
                <form method="POST" action="{{route('actor.update')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card-body row">
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <input type="text" name="name" class="form-control" id="name_book" placeholder="name catagory" value="{{$actor->name}}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <input type="hidden" name="id" value="{{$actor->id}}" style="display:none">
                    <!-- End Row -->
                    {{--End row--}}
