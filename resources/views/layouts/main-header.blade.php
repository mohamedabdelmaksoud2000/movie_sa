							...
							<li class="">
								<div class="dropdown  nav-itemd-none d-md-flex">
									<a href="#" class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown" aria-expanded="false">
										<span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img src="{{URL::asset('assets/img/lang/'.app()->getLocale().'.png')}}" alt="img"></span>
										<div class="my-auto">
									...
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											...
											<div class="mr-3 my-auto">
												<h6>@auth{{Auth::user()->name}}@else moahmed ahmed @endauth</h6><span>Premium Member</span>
											</div>
										</div>
									</div>
                                        ...
                                        @auth
                                            <form method="POST" action="{{ route('logout') }}">
                                                ...
                                                <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault();this.closest('form').submit();">
                                                    <i class="bx bx-slider-alt"></i>logout
                                                </a>
                                            </form>
                                        @endauth
                                    @endif
